...
pdfcr(function(){
		...
		pdfcr(document).on('click','form button',function(){
			...
			pdfcr(this).before('<img class="loadingImg" style="height: 20px; margin: 3px;" src="'+pdftvtpl2LetterPage_plugin_url_letterpage+'/assets/img/loading.gif">')
			}
			...
			pdfcr.post(
				...
				function(response){
					...
					if(totalnewcontentheight>1155){
						...
						datus.add_widget('<li class=" /*no-resize static*/" data-col=""  data-row=""  style="background: rgb(255, 255, 199);"  ><div class="settings-wrap"><button style="float: right;"  class="close-grid" type="button">x</button><div style="float:right" title="edit main body style" class="pdftv2-button-column-settings" id="pdftv2-button-column-settings" data-target="#pdftv2-column-settings-edit" data-toggle="modal"><img style="height: 20px; margin: 3px;" src="'+pdftvtpl2LetterPage_plugin_url_letterpage+'/assets/img/settings-icon.png"></div></div><div class="grid-content-wrap" style="padding:10px;" >'+pdfcr('.readymadecontentAppend').html()+'</div></li>', 120, rH);	
			...
			pdfcr.post(
				...
				function(response){
					...
					if(totalnewcontentheight>1162){
						...
						datus.add_widget('<li class=" /*no-resize static*/" data-col=""  data-row="" style="background: rgb(255, 255, 199);"  ><div class="settings-wrap"><button style="float: right;"  class="close-grid" type="button">x</button><div style="float:right" title="edit main body style" class="pdftv2-button-column-settings" id="pdftv2-button-column-settings" data-target="#pdftv2-column-settings-edit" data-toggle="modal"><img style="height: 20px; margin: 3px;" src="'+pdftvtpl2LetterPage_plugin_url_letterpage+'/assets/img/settings-icon.png"></div></div><div class="grid-content-wrap" style="padding:10px;" >'+pdfcr('.readymadecontentAppend').html()+'</div></li>', parseInt(rW), parseInt(rH));	
