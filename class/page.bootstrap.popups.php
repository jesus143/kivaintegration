...
namespace Umbrella\FOM;


class FomPopups extends FomBuilder{
				   ...
				   <div class="row">
					  <div class="col-sm-6">
						 <label for="email">Readymade Content Categories</label>
							...
							$terms = get_terms( 'pdfReadymade_letterpage', array(
								'orderby'    => 'count',
								'hide_empty' => 0,
								'number' => 8
				   ...
				   <div class="row">
					  <div class="col-sm-6">
						 <label for="email">Advertisement Content Categories</label>
							...
							$terms = get_terms( 'pdftpl2advertisement_letterpage', array(
								'orderby'    => 'count',
								'hide_empty' => 0,
								'number' => 8
                    ...
                    <div class="modal-body" style="padding-top: 0px;padding-bottom: 0px;">
                        <div class="row">
                            ...
                            <div class="col-sm-3 pdftv2-popup-shortcodes pre-scrollable" >
								...
								global $pdftvtpl2LetterPage_short;

								foreach($pdftvtpl2LetterPage_short as $shortfield){
								...
								<!--
								<?php $headerstofields = get_post_meta($_REQUEST['letter_id'],'customer_list_head',true); ?>
								...
								<?php }elseif(get_post_meta($_REQUEST['letter_id'],'httpfile',true)!=""){ ?>

								<?php
										$parts = parse_url(get_post_meta($_REQUEST['letter_id'],'httpfile',true));
			...
			<div class="modal-dialog modal-lg" style="max-width:700px;">
				...
				<div class="modal-content">
					<div class="modal-header">
						...
						echo "<a href='".site_url()."/wp-admin/admin.php?page=pdftpl-default-news-values&letter_id=".$_GET['letter_id']."'>Click Here to Edit default values</a>";
						}
					...
					<div class="modal-body">
						...
						<table class="table">
							...
							foreach($pdftvtpl2LetterPage_allfields_letterpage_defaults as $key=>$val){
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="pre-scrollable">
							<ul>
								<li style="text-align:center; "><img style="height: 20px; margin: 4px;" src="<?php echo pdftvtpl2LetterPage_plugin_url_letterpage; ?>/assets/img/loading.gif" /></li>
							</ul>
						</div>
                    </div>
                    <div class="modal-footer">
            ...
            <div class="modal-dialog modal-lg">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="col-md-12">
                            <div class="col-md-4">
                            <img  src="<?php echo pdftvtpl2LetterPage_plugin_url_letterpage; ?>/assets/img/a4a5.png" /><br /><br />
                            ...
                            <div class="col-md-8">
                                ...
                                <p align="center">
									<button ng-click="addpdftpla4a5('A4')" type="button" class="btn btn-default">Send in Full A4 Size ></button>
									<button ng-click="addpdftpla4a5('A5')" type="button" class="btn btn-default">Fold & Send in A5 Size ></button>
